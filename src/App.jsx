      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Pari baby</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Pari's's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>Your special day is here and im so happy that you were born hehe :3💗</p>
        </section>
